        ...
        <div className="grid md:grid-cols-12 gap-10">
          <div className="md:col-span-5">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://www.instagram.com/walesdrum/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-foreground text-background flex items-center justify-center hover:bg-warm transition-colors"
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="https://www.instagram.com/walesdrum/" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-warm transition-colors link-draw">Instagram</a></li>
              <li><a href="https://x.com/cdoubleu14" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-warm transition-colors link-draw">X (Twitter)</a></li>
            </ul>
          </div>
        </div>
